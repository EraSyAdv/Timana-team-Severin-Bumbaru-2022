...
<section name="admitere" id="admitere" class="masthead page-section">
    <div class="container">
        ...
        @endif
        <form class="text-center" action="{{ route('university.scheduleFilePost') }}" method="POST">
            @csrf
            ...
            <div class="form-group pb-4">
                <label class="pb-2" for="email">Numar/Cod unic de inregistrare<label style="color: #fd7e14">*</label></label>
                <input type="text" class="form-control text-center pb-2" style="margin: auto; display: block; width: 20rem;" id="code" name="code" aria-dscribedby="nr-inregistrare" placeholder="Nr./Cod de inregistrare">
            </div>
            <div class="form-group pb-4">
